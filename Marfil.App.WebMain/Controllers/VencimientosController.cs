...
{
    [Authorize]
    public class VencimientosController : GenericController<VencimientosModel>
    {
        ...
        {
            MenuName = "vencimientosventa";
            var permisos = appService.GetPermisosMenu("vencimientosventa");
        ...
        public VencimientosController(IContextService context) : base(context)
        {
        ...
        {
            var modelview = Helper.fModel.GetModel<VencimientosModel>(ContextService) as VencimientosModel;
            using (var gestionService = createService(modelview as VencimientosModel) as VencimientosService)
            {
                var model = gestionService.GetListIndexModelCobros(typeof(VencimientosModel), CanEliminar, CanModificar, ControllerContext.RouteData.Values["controller"].ToString());
        ...
        public override ActionResult Create()
        {
            ...
            model.Tipo = TipoVencimiento.Cobros;
            model.Situacion = "X";
            model.Fkseriescontables = serviceSeries.getSerieEjercicio("PRC");
