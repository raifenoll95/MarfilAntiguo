...
{
    public class AsignacionSituacionesApiController : ApiBaseController
    {
        public AsignacionSituacionesApiController(IContextService context) : base(context)
        {
        }
        ...
        public HttpResponseMessage Get()
        {
            ...
            var circuito = nvc["circuito"];

            using (var service = new SituacionesTesoreriaService(ContextService))
            {
                var listsituaciones = service.getSituacion(circuito);
