...
{
    public class ProyectosController : GenericController<ProyectosModel>
    {        
        ...
        {
            MenuName = "proyectos";
            var permisos = appService.GetPermisosMenu("proyectos");
        ...
        public ProyectosController(IContextService context) : base(context)
        {
        ...
        public override ActionResult Create()
        {
            ...
            using (var gestionService = FService.Instance.GetService(typeof(ProyectosModel), ContextService))
            {
                var newmodel = Helper.fModel.GetModel<ProyectosModel>(ContextService);

                Session[sessionSeguimientos] = ((ProyectosModel)newmodel).Seguimientos;
        ...
        public override ActionResult Edit(string id)
        {
            ...
            {
                var model = TempData["model"] != null ? TempData["model"] as ProyectosModel : gestionService.get(id);

                if (model == null)
                {
                    return HttpNotFound();
                }
                Session[sessionSeguimientos] = ((ProyectosModel)model).Seguimientos;
        ...
        {
            var objModel = model as ProyectosModel;
            ...
            if (!objModel.Cerrado)
            {
                result.Add(new ToolbarActionModel()
                {
                    ...
                    Url = Url.Action("Generar", "Seguimientos", new
                    {
                        ...
                        tipodocumento = DocumentoEstado.Proyectos,
