...
{
    public class CuentasClienteApiController : ApiBaseController
    {
        public CuentasClienteApiController(IContextService context) : base(context)
        {
        }
        // GET: api/CuentasClienteApi
        ...
        public HttpResponseMessage Get()
        {
            ...
            using (var service = FService.Instance.GetService(typeof(CuentasModel),ContextService) as CuentasService)
            {
                ...
                {
                    values = service.GetCuentasClientes().ToList(),
                    columns = new[]
                    {
