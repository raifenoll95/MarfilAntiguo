...
{
    public class CuentasTiposClientesExclusiveFacturacionApiController : ApiBaseController
    {
        public CuentasTiposClientesExclusiveFacturacionApiController(IContextService context) : base(context)
        {
        }
        ...
        public HttpResponseMessage Get()
        {
            ...
            using (var service = FService.Instance.GetService(typeof(ClientesModel),ContextService) as ClientesService)
            {
                ...
                var result = new ResultBusquedas<ClientesModel>()
                {
                    values = service.GetClientesPendientesFacturar(),
                    columns = new[]
                    {
