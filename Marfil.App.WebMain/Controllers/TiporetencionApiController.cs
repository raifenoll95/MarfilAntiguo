...
{
    public class TiporetencionApiController : ApiBaseController
    {
        public TiporetencionApiController(IContextService context) : base(context)
        {
        }
        ...
        public HttpResponseMessage Get(string id)
        {
            ...
            using (var service = FService.Instance.GetService(typeof(TiposRetencionesModel),ContextService))
            {
                ...
                var list = service.get(id) as TiposRetencionesModel;
                var response = Request.CreateResponse(HttpStatusCode.OK);
