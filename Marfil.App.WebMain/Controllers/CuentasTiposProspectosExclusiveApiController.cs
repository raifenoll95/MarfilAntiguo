...
{
    public class CuentasTiposProspectosExclusiveApiController : ApiBaseController
    {
        public CuentasTiposProspectosExclusiveApiController(IContextService context) : base(context)
        {
        }
