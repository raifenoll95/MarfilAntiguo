...
{
    public class PruebaApiController : ApiBaseController
    {

        public PruebaApiController(IContextService context) : base(context)
        {
        ...
        public HttpResponseMessage Get()
        {
            ...
            using (var service = FService.Instance.GetService(typeof(AcabadosModel), ContextService) as AcabadosService)
            {
                ...
                var result = new ResultBusquedas<AcabadosModel>()
                {
                    values = service.getAll().Select(f => (AcabadosModel)f),
                    columns = new[]
                    {
                ...
                */
                ...
                response.Content = new StringContent("hola");
                return response;
            }
        }
    ...
    /*
        ...
        public HttpResponseMessage Get(string id)
        {
            ...
            {
                service.Empresa = ContextService.Empresa;
                var list = service.get(id) as AcabadosModel;
                var response = Request.CreateResponse(HttpStatusCode.OK);
