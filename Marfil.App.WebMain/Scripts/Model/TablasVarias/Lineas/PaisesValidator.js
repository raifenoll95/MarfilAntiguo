var PaisesValidator = (function () {
    function PaisesValidator() {
    }
    PaisesValidator.prototype.IsValidObject = function (data, obj) {
        ...
        obj.Valor = Funciones.RellenaCeros(obj.Valor, 3);
        obj.CodigoIsoAlfa3 = obj.CodigoIsoAlfa3.toUpperCase();
        obj.CodigoIsoAlfa2 = obj.CodigoIsoAlfa2.toUpperCase();
        return true;
    };
    return PaisesValidator;
}());
//# sourceMappingURL=PaisesValidator.js.map