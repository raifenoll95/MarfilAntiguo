app.controller('AlbaranesCtrl', ['$scope', '$http', '$location', '$window', '$timeout', function ($scope, $http, $location, $window, $timeout) {
    ...
    $scope.init = function (firstEdit, proveedor, agente, comercial, direccionfacturacion, bancomandato, fkobras, isnuevo, tipodeportes, urlrefrescar, urlApiBancos, urlImportarlineas, urlDescargaDefecto)
    {
    ...
    $scope.ImportarLineas = function(url) {
        var obj = {
            ...
            Params: "{ \"proveedor\":\"" + $("[name='Fkproveedores']").val() + "\" ,\"PedidosDesde\":\"" + $("[name='PedidosDesde']").val() + "\", \"PedidosHasta\":\"" + $("[name='PedidosHasta']").val() + "\"}"
    ...
    function SetCabeceraValues(cabecera) {
        ...
        $("[name='Nombreproveedor']").val(cabecera.Nombreproveedor);
        $("[name='Proveedordireccion']").val(cabecera.Proveedordireccion);
        $("[name='Proveedorpoblacion']").val(cabecera.Proveedorpoblacion);
        $("[name='Proveedorcp']").val(cabecera.Proveedorcp);
        $("[name='Proveedorpais']").val(cabecera.Proveedorpais);
        $("[name='Proveedorprovincia']").val(cabecera.Proveedorprovincia);
        $("[name='Proveedortelefono']").val(cabecera.Proveedortelefono);
        $("[name='Proveedorfax']").val(cabecera.Proveedorfax);
        $("[name='Proveedoremail']").val(cabecera.Proveedoremail);
        $("[name='Proveedornif']").val(cabecera.Proveedornif);
