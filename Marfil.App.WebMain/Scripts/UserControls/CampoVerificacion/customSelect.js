(function (angular, undefined) {
	...
	var module = angular.module('campoverificacionModule', []);

	module.value('customSelectDefaults', {
		displayText: 'Selecciona un elemento',
		emptyListText: 'No hay elementos',
		...
		return {
			...
			link: function (scope, elem, attrs, controller) {
				...
				var itemTemplate = elem.html().trim() || '{{' + (match[2] || match[1]) + '}}',
					...
					dropdownTemplate =
					'<a class="color-black dropdown-toggle" data-toggle="dropdown" href ng-class="{ disabled: disabled }">' +
