...
{
    internal class NifValidator_ES : INifValidator
    {
        #region Members
        ...
        private class NumeroNif
        {
            ...
            private bool CompruebaNie()
            {
                var nie_prefix = numero.Substring(0, 1);
                ...
                numero = nie_prefix + numero.Substring(1);
                Desglosa();
                return CompruebaNif();
            }
        ...
        public NifValidator_ES(ICheckPaisEuropeo checkPaisEuropeoService)
        {
