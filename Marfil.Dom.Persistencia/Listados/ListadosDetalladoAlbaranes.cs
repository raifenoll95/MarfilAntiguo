...
{
    public class ListadosDetalladoAlbaranes : ListadosModel
    {
        ...
        public override string IdListado => FListadosModel.AlbaranesDetallado;
        ...
        public ListadosDetalladoAlbaranes()
        {
            
        }

        public ListadosDetalladoAlbaranes(IContextService context) : base(context)
        {
        ...
        internal override string GenerarSelect()
        {
            var sb = new StringBuilder();
                ...
                " pl.fkarticulos as [Cod. Artículo], pl.descripcion as [Artículo],ud.textocorto as [UM],pl.lote as [Lote],pl.caja as [Caja],pl.bundle as [Bundle],pl.contenedor as [Contenedor],cn.descripcion as [Canal], pl.cantidad as [Cantidad],pl.largo as [Largo],pl.ancho as [Ancho],pl.grueso as [Grueso],pl.metros as [Metros], pl.precio as [Precio],pl.porcentajedescuento as [% Dto.],pl.importe as Subtotal,mo.abreviatura as [Moneda],mo.decimales as [_decimales], ud.decimalestotales as [_decimalesunidades] from Albaranes as p " +
                " inner join Albaraneslin as pl on pl.empresa= p.empresa and pl.fkalbaranes= p.id inner join clientes as c on c.empresa= p.empresa and p.fkclientes= c.fkcuentas inner join cuentas as cu on c.empresa= cu.empresa and c.fkcuentas=cu.id and cu.tipocuenta= " +
