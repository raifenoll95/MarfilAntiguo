...
{
    public class ListadosAlbaranes : ListadosModel
    {
        private List<string> _series = new List<string>();

        #region Properties

        public override string TituloListado => "Listado de Albaranes";

        public override string IdListado
        {
            get { return Agrupacion == "2" ? FListadosModel.AlbaranesCabeceraAgrupado : FListadosModel.AlbaranesCabecera; }
        }

        public override string WebIdListado => FListadosModel.AlbaranesCabecera;
        ...
        public ListadosAlbaranes()
        {
            
        }

        public ListadosAlbaranes(IContextService context):base(context)
        {
