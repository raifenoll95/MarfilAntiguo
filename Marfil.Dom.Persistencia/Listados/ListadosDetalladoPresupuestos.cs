...
{
    public class ListadosDetalladoPresupuestos : ListadosModel
    {
        private List<string> _series = new List<string>();

        #region Properties

        public override string TituloListado => "Listado detallado de presupuestos";

        public override string IdListado => FListadosModel.PresupuestosDetallado;

        public string Order { get; set; }

        [Display(ResourceType = typeof (RPresupuestos), Name = "SeriesListado")]
        ...
        [Display(ResourceType = typeof(RPresupuestos), Name = "FechaDesde")]
        public DateTime? FechaDesde { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "FechaHasta")]
        public DateTime? FechaHasta { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "ClienteDesde")]
        public string CuentaDesde { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "ClienteHasta")]
        ...
        [Display(ResourceType = typeof(RPresupuestos), Name = "FkarticulosDesde")]
        public string FkarticulosDesde { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "FkarticulosHasta")]
        public string FkarticulosHasta { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "FamiliaMateriales")]
        public string Fkfamiliasmateriales{ get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "FamiliaDesde")]
        public string FkfamiliasDesde { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "FamiliaHasta")]
        public string FkfamiliasHasta { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "MaterialesDesde")]
        public string FkmaterialesDesde { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "MaterialesHasta")]
        public string FkmaterialesHasta { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "CaracteristicasDesde")]
        public string FkcaracteristicasDesde { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "CaracteristicasHasta")]
        public string FkcaracteristicasHasta { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "GrosoresDesde")]
        public string FkgrosoresDesde { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "GrosoresHasta")]
        public string FkgrosoresHasta { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "AcabadosDesde")]
        public string FkacabadosDesde { get; set; }

        [Display(ResourceType = typeof(RPresupuestos), Name = "AcabadosHasta")]
        ...
        public List<EstadosModel> Estados
        {
            get
            {
                ...
                {
                    var list = estadoService.GetStates(DocumentoEstado.PresupuestosVentas).ToList();
        ...
        public ListadosDetalladoPresupuestos()
        {

        }

        public ListadosDetalladoPresupuestos(IContextService context) : base(context)
        {
        ...
        internal override string GenerarFiltrosColumnas()
        {
            ...
            if (Series?.Any() ?? false)
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.SeriesListado, string.Join(", ", Series.ToArray())));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(Estado) && !Estado.Equals("0-"))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.Estado, Estados?.First(f => f.CampoId == Estado).Descripcion??string.Empty));
                flag = true;
            }
            ...
            if (FechaDesde.HasValue)
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.FechaDesde, FechaDesde));
                flag = true;
            }
            ...
            if (FechaHasta.HasValue)
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.FechaHasta, FechaHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkarticulosDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.FkarticulosDesde, FkarticulosDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkarticulosHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.FkarticulosHasta, FkarticulosHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(Fkfamiliasmateriales))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.FamiliaMateriales, AppService.GetListFamiliaMateriales().SingleOrDefault(f => f.Valor == Fkfamiliasmateriales).Descripcion));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkfamiliasDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.FamiliaDesde, FkfamiliasDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkfamiliasHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.FamiliaHasta, FkfamiliasHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkmaterialesDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.MaterialesDesde, FkmaterialesDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkmaterialesHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.MaterialesHasta, FkmaterialesHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkcaracteristicasDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.CaracteristicasDesde, FkcaracteristicasDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkcaracteristicasHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.CaracteristicasHasta, FkcaracteristicasHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkgrosoresDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.GrosoresDesde, FkgrosoresDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkgrosoresHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.GrosoresHasta, FkgrosoresHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkacabadosDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.AcabadosDesde, FkacabadosDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkacabadosHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RPresupuestos.AcabadosHasta, FkacabadosHasta));
                flag = true;
            }
        ...
        internal override string GenerarSelect()
        {
            var sb = new StringBuilder();
                ...
                " pl.fkarticulos as [Cod. Artículo], pl.descripcion as [Artículo],ud.textocorto as [UM],pl.revision as [Revision],cn.descripcion as  [Canal], pl.cantidad as [Cantidad],pl.Largo as [Largo],pl.Ancho as [Ancho],pl.Grueso as [Grueso],pl.metros as [Metros], pl.precio as [Precio],pl.porcentajedescuento as [% Dto.],pl.importe as Subtotal,mo.abreviatura as [Moneda],mo.decimales as [_decimales], ud.decimalestotales as [_decimalesunidades] from presupuestos as p " +
                " inner join presupuestoslin as pl on pl.empresa= p.empresa and pl.fkpresupuestos= p.id inner join clientes as c on c.empresa= p.empresa and p.fkclientes= c.fkcuentas inner join cuentas as cu on c.empresa= cu.empresa and c.fkcuentas=cu.id and cu.tipocuenta= " +
        ...
        public IEnumerable<SeriesModel> SeriesListado
        {
            get
            {
                ...
                return service.GetSeriesTipoDocumento(TipoDocumento.PresupuestosVentas);
            }
        }
    }
}
