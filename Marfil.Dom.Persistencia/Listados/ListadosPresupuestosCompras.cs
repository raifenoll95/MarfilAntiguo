...
namespace Marfil.Dom.Persistencia.Listados
{
    ...
    public class ListadosPresupuestosCompras : ListadosModel
    {
        private List<string> _series = new List<string>();

        #region Properties

        public override string TituloListado => "Listado de Presupuestos Compras";

        public override string IdListado
        {
            get { return Agrupacion=="2" ? FListadosModel.PresupuestosComprasCabeceraAgrupado : FListadosModel.PresupuestosComprasCabecera; }
        }

        public override string WebIdListado => FListadosModel.PresupuestosComprasCabecera;
        ...
        public ListadosPresupuestosCompras()
        {

        }

        public ListadosPresupuestosCompras(IContextService context) : base(context)
        {
