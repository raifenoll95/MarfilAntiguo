...
{
    public class ListadosDetalladoFacturas : ListadosModel
    {
        private List<string> _series = new List<string>();

        #region Properties

        public override string TituloListado => "Listado detallado de Facturas";

        public override string IdListado => FListadosModel.FacturasDetallado;
        ...
        [Display(ResourceType = typeof(RFacturas), Name = "FkarticulosDesde")]
        public string FkarticulosDesde { get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "FkarticulosHasta")]
        public string FkarticulosHasta { get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "FamiliaMateriales")]
        public string Fkfamiliasmateriales{ get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "FamiliaDesde")]
        public string FkfamiliasDesde { get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "FamiliaHasta")]
        public string FkfamiliasHasta { get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "MaterialesDesde")]
        public string FkmaterialesDesde { get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "MaterialesHasta")]
        public string FkmaterialesHasta { get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "CaracteristicasDesde")]
        public string FkcaracteristicasDesde { get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "CaracteristicasHasta")]
        public string FkcaracteristicasHasta { get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "GrosoresDesde")]
        public string FkgrosoresDesde { get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "GrosoresHasta")]
        public string FkgrosoresHasta { get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "AcabadosDesde")]
        public string FkacabadosDesde { get; set; }

        [Display(ResourceType = typeof(RFacturas), Name = "AcabadosHasta")]
        ...
        public ListadosDetalladoFacturas()
        {

        }

        public ListadosDetalladoFacturas(IContextService context) : base(context)
        {
        ...
        internal override string GenerarFiltrosColumnas()
        {
            ...
            if (!string.IsNullOrEmpty(FkarticulosDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.FkarticulosDesde, FkarticulosDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkarticulosHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.FkarticulosHasta, FkarticulosHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(Fkfamiliasmateriales))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.FamiliaMateriales, AppService.GetListFamiliaMateriales().SingleOrDefault(f => f.Valor == Fkfamiliasmateriales).Descripcion));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkfamiliasDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.FamiliaDesde, FkfamiliasDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkfamiliasHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.FamiliaHasta, FkfamiliasHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkmaterialesDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.MaterialesDesde, FkmaterialesDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkmaterialesHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.MaterialesHasta, FkmaterialesHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkcaracteristicasDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.CaracteristicasDesde, FkcaracteristicasDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkcaracteristicasHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.CaracteristicasHasta, FkcaracteristicasHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkgrosoresDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.GrosoresDesde, FkgrosoresDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkgrosoresHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.GrosoresHasta, FkgrosoresHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkacabadosDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.AcabadosDesde, FkacabadosDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkacabadosHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturas.AcabadosHasta, FkacabadosHasta));
                flag = true;
            }
        ...
        internal override string GenerarSelect()
        {
            var sb = new StringBuilder();
                ...
                " pl.fkarticulos as [Cod. Artículo], pl.descripcion as [Artículo],ud.textocorto as [UM],pl.lote as [Lote],pl.caja as [Caja],pl.bundle as [Bundle],pl.contenedor as [Contenedor],cn.descripcion as [Canal], pl.cantidad as [Cantidad],pl.largo as [Largo],pl.ancho as [Ancho],pl.grueso as [Grueso],pl.metros as [Metros], pl.precio as [Precio],pl.porcentajedescuento as [% Dto.],pl.importe as Subtotal,mo.abreviatura as [Moneda],mo.decimales as [_decimales], ud.decimalestotales as [_decimalesunidades] from Facturas as p " +
                " inner join Facturaslin as pl on pl.empresa= p.empresa and pl.fkFacturas= p.id inner join clientes as c on c.empresa= p.empresa and p.fkclientes= c.fkcuentas inner join cuentas as cu on c.empresa= cu.empresa and c.fkcuentas=cu.id and cu.tipocuenta= " +
