...
namespace Marfil.Dom.Persistencia.Model.CRM
{
    ...
    public class IncidenciasCRMModel : BaseModel<IncidenciasCRMModel, IncidenciasCRM>
    {
        ...
        public override string DisplayName => RCRM.TituloEntidadIncidencias;

        #region CTR

        public IncidenciasCRMModel()
        {

        }

        public IncidenciasCRMModel(IContextService context) : base(context)
        {
