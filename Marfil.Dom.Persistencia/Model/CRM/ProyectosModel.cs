...
namespace Marfil.Dom.Persistencia.Model.CRM
{
    ...
    public class ProyectosModel : BaseModel<ProyectosModel, Proyectos>
    {
        ...
        [Display(ResourceType = typeof(RCRM), Name = "Obra")]
        ...
        public override string DisplayName => RCRM.TituloEntidadProyectos;
        ...
        public ProyectosModel(IContextService context) : base(context)
        {
