    ...
    internal class CuentastesoreriaConverterService : BaseConverterModel<CuentastesoreriaModel, Cuentastesoreria>
    {
        ...
        public override IEnumerable<IModelView> GetAll()
        {
            ...
            foreach (var item in list)
            {
                ...
                newitem.Direcciones.Direcciones = direccionesService.GetDirecciones(TiposCuentas.Cuentastesoreria, newitem.Fkcuentas);
        ...
        public override IModelView CreateView(string id)
        {
            ...
            result.Direcciones.Direcciones = direccionesService.GetDirecciones(TiposCuentas.Cuentastesoreria, obj.fkcuentas);
