    ...
    internal class OperariosConverterService : BaseConverterModel<OperariosModel, Operarios>
    {
        ...
        public override IEnumerable<IModelView> GetAll()
        {
            ...
            foreach (var item in list)
            {
                ...
                newitem.Direcciones.Direcciones = direccionesService.GetDirecciones(TiposCuentas.Operarios, newitem.Fkcuentas);
        ...
        public override IModelView CreateView(string id)
        {
            ...
            result.Direcciones.Direcciones = direccionesService.GetDirecciones(TiposCuentas.Operarios, obj.fkcuentas);
