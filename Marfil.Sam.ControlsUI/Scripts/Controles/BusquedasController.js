app.controller('BusquedasCtrl', ['$scope','$rootScope', '$http', '$interval', 'uiGridConstants', function ($scope, $rootScope,$http, $interval, uiGridConstants) {
    ...
    $scope.gridOptions.rowTemplate = '<div ng-dblclick="grid.appScope.onDblClick(row)" ng-repeat="col in colContainer.renderedColumns track by col.colDef.name" class="ui-grid-cell" ui-grid-cell></div>';
